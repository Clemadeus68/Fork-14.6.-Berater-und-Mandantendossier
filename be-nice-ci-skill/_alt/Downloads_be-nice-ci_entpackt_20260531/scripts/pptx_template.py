...
# Wird das Skript an einen anderen Ort kopiert, BENICE_LOGOS-Umgebungsvariable
# auf den absoluten Pfad des assets/-Ordners dieses Skills setzen.
LOGOS = os.environ.get(
    'BENICE_LOGOS',
    os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'assets')
)

LOGO_BENICE  = os.path.join(LOGOS, 'be-nice.png')           # immer aktiv

# FOOTER-LOGOS: gewünschte aktivieren (Kommentar entfernen)
# LOGO_ACN    = f'{LOGOS}/alchimedus-netzwerk.png'
# LOGO_MASTER = f'{LOGOS}/alchimedus-master.jpg'
# LOGO_INQA   = f'{LOGOS}/inqa.jpg'
