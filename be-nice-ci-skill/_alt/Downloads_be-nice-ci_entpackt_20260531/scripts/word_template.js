 ...
 *   Logos unter /Users/clemensgutmann/Documents/Claude/Assets/Logos/
 */
...
// ── Logo-Pfade ────────────────────────────────────────────────────────────────
// Logos liegen im Skill-Ordner unter assets/ (relativ zu diesem Skript).
// Wird das Skript an einen anderen Ort kopiert, LOGOS auf den absoluten
// Pfad des assets/-Ordners dieses Skills setzen.
const LOGOS = process.env.BENICE_LOGOS || path.join(__dirname, '..', 'assets');

const IMG_BENICE = fs.readFileSync(path.join(LOGOS, 'be-nice.png'));

// FOOTER-LOGOS: gewünschte auskommentieren / aktivieren
// const IMG_ACN    = fs.readFileSync(`${LOGOS}/alchimedus-netzwerk.png`);
// const IMG_MASTER = fs.readFileSync(`${LOGOS}/alchimedus-master.jpg`);
// const IMG_INQA   = fs.readFileSync(`${LOGOS}/inqa.jpg`);
        ...
        new TableCell({
          ...
          children: [new Paragraph({
            children: [new ImageRun({
              ...
              transformation: { width: 125, height: 68 },
